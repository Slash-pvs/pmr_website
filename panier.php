...
// Inclusion des fonctions et de la DB
        ...
        <div id="panier-content">
            ...
            <?php else: ?>
                    ...
                    <table>
                        ...
                        <?php foreach ($panier as $index => $article):
                            ...
                            <tr data-index="<?= $index ?>">
                                ...
                                <td data-label="Prix Unitaire"><?= number_format($article['prix'], 2, ',', ' ') ?> €</td>
                                <td data-label="Total"><?= number_format($article['quantite'] * $article['prix'], 2, ',', ' ') ?> €</td>
                ...
                <form action="/includes/validation_commande.php" method="POST">
                    ...
                    <textarea name="message" placeholder="Informations complémentaires (facultatif)" rows="4"></textarea>
